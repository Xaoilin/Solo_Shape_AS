...
public class TierOneLevelFiles extends LevelFiles {
    ...
    private void Level10(String[] fileArray, int gameLvl) {
        ...
        file.writeString("2, " + (gameWidth / 10) * 1 + ", " + (gameHeight / 10) * 2 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, "	+ (gameWidth / 10) * 3 + ", " + (gameHeight / 10) * 2 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, "	+ (gameWidth / 10) * 5 + ", " + (gameHeight / 10) * 2 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, "	+ (gameWidth / 10) * 7 + ", " + (gameHeight / 10) * 2 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 9 + ", " + (gameHeight / 10) * 2 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 9 + ", " + (gameHeight / 10) * 3 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 9 + ", " + (gameHeight / 10) * 4 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 9 + ", " + (gameHeight / 10) * 5 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 9 + ", " + (gameHeight / 10) * 6 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 9 + ", " + (gameHeight / 10) * 7 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 9 + ", " + (gameHeight / 10) * 8 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 9 + ", " + (gameHeight / 10) * 9 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 7 + ", " + (gameHeight / 10) * 9 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 5 + ", " + (gameHeight / 10) * 9 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 3 + ", " + (gameHeight / 10) * 9 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 1 + ", " + (gameHeight / 10) * 9 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 1 + ", " + (gameHeight / 10) * 8 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 1 + ", " + (gameHeight / 10) * 7 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 1 + ", " + (gameHeight / 10) * 6 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 1 + ", " + (gameHeight / 10) * 5 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 1 + ", " + (gameHeight / 10) * 4 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 3 + ", " + (gameHeight / 10) * 4 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 5 + ", " + (gameHeight / 10) * 4 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 5 + ", " + (gameHeight / 10) * 5 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 5 + ", " + (gameHeight / 10) * 6 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "2, " + (gameWidth / 10) * 5 + ", " + (gameHeight / 10) * 7 + ", 0, 0, 0, 0.3, 0, 0, 0\n, "
                        + "6, " + (gameWidth / 10) * 1 + ", " + (gameHeight / 10) * 3 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "3, " + (gameWidth / 10) * 3 + ", " + (gameHeight / 10) * 3 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "7, " + (gameWidth / 10) * 5 + ", " + (gameHeight / 10) * 3 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "5, " + (gameWidth / 10) * 7 + ", " + (gameHeight / 10) * 3 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "6, " + (gameWidth / 10) * 7 + ", " + (gameHeight / 10) * 4 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "3, " + (gameWidth / 10) * 7 + ", " + (gameHeight / 10) * 5 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "7, " + (gameWidth / 10) * 7 + ", " + (gameHeight / 10) * 6 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "5, " + (gameWidth / 10) * 7 + ", " + (gameHeight / 10) * 7 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "6, " + (gameWidth / 10) * 7 + ", " + (gameHeight / 10) * 8 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "3, " + (gameWidth / 10) * 5 + ", " + (gameHeight / 10) * 8 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "7, " + (gameWidth / 10) * 3 + ", " + (gameHeight / 10) * 8 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "5, "	+ (gameWidth / 10) * 3 + ", " + (gameHeight / 10) * 7 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "6, "	+ (gameWidth / 10) * 3 + ", " + (gameHeight / 10) * 6 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                        + "3, "	+ (gameWidth / 10) * 3 + ", " + (gameHeight / 10) * 5 + ", 0, 0, 1, 0.2, 0, 0, 0\n, "
                , false);
    ...
    private void Level2(String[] fileArray, int gameLvl) {
        ...
        FileHandle file = Gdx.files.local("Level" + gameLvl + ".txt");
        file.writeString("2, " + (gameWidth / 2) + ", " + (gameHeight / 2) * 1 + ", 0, 1, 0, 0.8, 0, 0, 0",false);
